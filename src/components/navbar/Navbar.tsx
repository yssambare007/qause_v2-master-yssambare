...
const Navbar: FC<NavbarProps> = (props: NavbarProps) => {
  ...
  return (
    <>
      <main className="sticky top-0 z-50 flex h-[10vh] w-full items-center justify-between bg-[#fff] px-[15px] py-[20px] shadow-[0px_0px_6px_0px_rgb(0,0,0,0.18)] lg:p-[15px]">
        <div className="flex items-center">
          ...
          />
          {/* <div className="relative" id={css.remove}>
            <SearchRoundedIcon
              sx={{
                position: "absolute",
                left: "10px",
            ...
            <input
              ...
              className="h-[45px] rounded-full border border-gray-400 px-[40px]"
              type="text"
              id={css.searchBar}
              placeholder="Search with NGO name or Category"
            />
          </div> */}
        </div>
        <div>
          <div className={`flex items-center justify-around gap-4`}>
            ...
            {/* <Link
              href="#"
              className={`cursor-pointer font-[muli] text-[1rem] ${router.pathname.includes("/blog") ? activeClass : "hover:text-[#f7a212]"}`}
              id="navTab"
            >
              Blogs
            </Link> */}
                  ...
                  {display && (
                    <>
                      ...
                      <div className="absolute right-[-10px] top-[50px] z-50 min-w-[200px] rounded-lg bg-[#fbfbfb] shadow-lg">
                        ...
                        <Link href={END_POINTS.ABOUT_NGO}>
